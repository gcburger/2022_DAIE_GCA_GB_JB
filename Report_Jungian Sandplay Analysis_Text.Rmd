...
There are several methods employed to assess patient PTSD including observer-rated (OR), self- reported (CPSS), parental reported, and physiological measurements. Note that only OR pre and post scores were used in this analysis due to reliability concerns of CPSS data since they are self reported outside a controlled and standardised manner which does not meet the requirement for a robust experiment, specific focus will be applied on the variance between the pre and post scores (impact).
